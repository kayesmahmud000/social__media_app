...
FutureOr<void> _createDB(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE $TABLE_POST (
        ...
        FOREIGN KEY ($COL_POST_USER_ID) REFERENCES $TABLE_USER ($COL_USER_ID) ON DELETE CASCADE
      )
    ''');
    ...
    await db.execute('''
      CREATE TABLE $TABLE_COMMENT (
        ...
        FOREIGN KEY ($COL_COMMENT_USER_ID) REFERENCES $TABLE_USER ($COL_USER_ID) ON DELETE CASCADE,
        FOREIGN KEY ($COL_COMMENT_POST_ID) REFERENCES $TABLE_POST ($COL_POST_ID) ON DELETE CASCADE
      )
    ''');
    ...
    await db.execute('''
      CREATE TABLE $TABLE_LIKE (
        ...
        FOREIGN KEY ($COL_LIKE_USER_ID) REFERENCES $TABLE_USER ($COL_USER_ID) ON DELETE CASCADE, 
        FOREIGN KEY ($COL_LIKE_POST_ID) REFERENCES $TABLE_POST ($COL_POST_ID) ON DELETE CASCADE
      )
    ''');
  }
}
